def greet_user():
    ...
    print(f"I'm glad to hear you're doing {name} today! Let's talk about your city.")
...
def greet_city():
    ...
    city_greetings = {
        ...
        "watford": "Welcome Watfordian! You find yourself in Watford, a city with a rich industrial heritage.",
        "aberdeen": "Welcome Aberdonian! You find yourself in Aberdeen, the Granite City.",
    }
...
def discuss_landmarks(city):
    city_landmarks = {
        ...
        "watford": ["Watford Regional Gallery", "Vicarage Road"],
        "aberdeen": ["Pittodrie", "Robert Gordon University"],
